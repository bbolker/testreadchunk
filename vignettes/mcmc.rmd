...
knitr::read_chunk(system.file("vignette_data","mcmc.R",package="testreadchunk"))
## system.file("vignette_data","mcmc.R",package="glmmTMB"))
## stop("working directory ",getwd(), paste(list.files(), collapse=", "))
```
